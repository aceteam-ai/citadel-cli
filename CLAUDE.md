...
1. Node authenticates to Tailscale network using device authorization or authkey
...
1. **Network Choice**: Checks if already connected to Tailscale, prompts for device authorization/authkey/skip
